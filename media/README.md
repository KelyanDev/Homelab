<h3 align="center">Media</h3>
  ...
  <p align="center">
    Regarding my media stack, I'm running 6 Debian LXC - 2 LXCs are for my Jellyfin and Seer instances, 3 LXCs for my *arr instances, and the last one is for my qBittorrent. This repository is my own <strong>WIP</strong> installation guide.
    <br />
    ...
    <br />
    <a href="https://github.com/KelyanDev/Homelab/blob/main/media/README.md"><strong>Media</strong></a>
    ·
